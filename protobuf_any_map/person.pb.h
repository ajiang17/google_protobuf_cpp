...
class Test_DataEntry_DoNotUse;
class Test_DataEntry_DoNotUseDefaultTypeInternal;
extern Test_DataEntry_DoNotUseDefaultTypeInternal _Test_DataEntry_DoNotUse_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::Test_DataEntry_DoNotUse* Arena::CreateMaybeMessage<::Test_DataEntry_DoNotUse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Apply_data :
 ...
 public:
  ...
  enum : int {
    kApplyNameFieldNumber = 1,
    kApplyTimeFieldNumber = 2,
  };
  // string apply_name = 1;
  void clear_apply_name();
  const std::string& apply_name() const;
  void set_apply_name(const std::string& value);
  void set_apply_name(std::string&& value);
  void set_apply_name(const char* value);
  void set_apply_name(const char* value, size_t size);
  std::string* mutable_apply_name();
  std::string* release_apply_name();
  void set_allocated_apply_name(std::string* apply_name);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr apply_name_;
...
class Apply_list :
 ...
 public:
  ...
  enum : int {
    kApplyListAddFieldNumber = 1,
    kApplyListIdFieldNumber = 2,
  };
  // string apply_list_add = 1;
  void clear_apply_list_add();
  const std::string& apply_list_add() const;
  void set_apply_list_add(const std::string& value);
  void set_apply_list_add(std::string&& value);
  void set_apply_list_add(const char* value);
  void set_apply_list_add(const char* value, size_t size);
  std::string* mutable_apply_list_add();
  std::string* release_apply_list_add();
  void set_allocated_apply_list_add(std::string* apply_list_add);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr apply_list_add_;
...
class Test_DataEntry_DoNotUse : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<Test_DataEntry_DoNotUse, 
    std::string, PROTOBUF_NAMESPACE_ID::Any,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE,
    0 > {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<Test_DataEntry_DoNotUse, 
    std::string, PROTOBUF_NAMESPACE_ID::Any,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE,
    0 > SuperType;
  Test_DataEntry_DoNotUse();
  Test_DataEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  void MergeFrom(const Test_DataEntry_DoNotUse& other);
  static const Test_DataEntry_DoNotUse* internal_default_instance() { return reinterpret_cast<const Test_DataEntry_DoNotUse*>(&_Test_DataEntry_DoNotUse_default_instance_); }
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), s->size(), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "Test.DataEntry.key");
 }
...
// string apply_name = 1;
inline void Apply_data::clear_apply_name() {
  apply_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Apply_data::apply_name() const {
  // @@protoc_insertion_point(field_get:Apply_data.apply_name)
  return apply_name_.GetNoArena();
}
inline void Apply_data::set_apply_name(const std::string& value) {
  
  apply_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:Apply_data.apply_name)
}
inline void Apply_data::set_apply_name(std::string&& value) {
  
  apply_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:Apply_data.apply_name)
}
inline void Apply_data::set_apply_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  apply_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Apply_data.apply_name)
}
inline void Apply_data::set_apply_name(const char* value, size_t size) {
  
  apply_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Apply_data.apply_name)
}
inline std::string* Apply_data::mutable_apply_name() {
  
  // @@protoc_insertion_point(field_mutable:Apply_data.apply_name)
  return apply_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Apply_data::release_apply_name() {
  // @@protoc_insertion_point(field_release:Apply_data.apply_name)
  
  return apply_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Apply_data::set_allocated_apply_name(std::string* apply_name) {
  if (apply_name != nullptr) {
    
  } else {
    
  }
  apply_name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), apply_name);
  // @@protoc_insertion_point(field_set_allocated:Apply_data.apply_name)
}
...
// string apply_list_add = 1;
inline void Apply_list::clear_apply_list_add() {
  apply_list_add_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& Apply_list::apply_list_add() const {
  // @@protoc_insertion_point(field_get:Apply_list.apply_list_add)
  return apply_list_add_.GetNoArena();
}
inline void Apply_list::set_apply_list_add(const std::string& value) {
  
  apply_list_add_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:Apply_list.apply_list_add)
}
inline void Apply_list::set_apply_list_add(std::string&& value) {
  
  apply_list_add_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:Apply_list.apply_list_add)
}
inline void Apply_list::set_apply_list_add(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  apply_list_add_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Apply_list.apply_list_add)
}
inline void Apply_list::set_apply_list_add(const char* value, size_t size) {
  
  apply_list_add_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Apply_list.apply_list_add)
}
inline std::string* Apply_list::mutable_apply_list_add() {
  
  // @@protoc_insertion_point(field_mutable:Apply_list.apply_list_add)
  return apply_list_add_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Apply_list::release_apply_list_add() {
  // @@protoc_insertion_point(field_release:Apply_list.apply_list_add)
  
  return apply_list_add_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Apply_list::set_allocated_apply_list_add(std::string* apply_list_add) {
  if (apply_list_add != nullptr) {
    
  } else {
    
  }
  apply_list_add_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), apply_list_add);
  // @@protoc_insertion_point(field_set_allocated:Apply_list.apply_list_add)
}
